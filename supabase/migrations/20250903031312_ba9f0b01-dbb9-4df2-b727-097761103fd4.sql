...
ALTER TABLE public.detection_details ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Allow authenticated read access to detection_details"
ON public.detection_details
FOR SELECT
TO authenticated
USING (true);
